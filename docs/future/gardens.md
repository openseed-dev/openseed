...
The dashboard could render gardens as visual groups in the sidebar, with creatures grouped under their garden name and an ungrouped section for loners. Long-term, the pixel art vision: top-down gardens separated by hedgerows, creatures as little sprites moving around inside them.
